...
const triggerActions = (count) => {
  ...
  async function callback(message) {
    try {
      // se utiliza try para ejecutar un código una vez que la promesa que envuelve a callback() se resuelve al ejecutarse el proceso
    ...
    } // por buena práctica, al menos ponemos un catch para obtener un error, si existe
  }
